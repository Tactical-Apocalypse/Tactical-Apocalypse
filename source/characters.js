...
class Player {
  ...
  move() {
    if (key("w") && this.pos.y - this.speed - this.radius > 0) {
      this.pos.y -= this.speed;
    }
    if (key("s") && this.pos.y + this.speed + this.radius < canvas.height) {
      this.pos.y += this.speed;
    }
    if (key("a") && this.pos.x - this.speed - this.radius > 0) {
      this.pos.x -= this.speed;
    }
    if (key("d") && this.pos.x + this.speed + this.radius < canvas.width) {
      this.pos.x += this.speed;
    }
  }
